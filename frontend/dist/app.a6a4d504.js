...
var JobSearch = /*#__PURE__*/function () {
  ...
  _createClass(JobSearch, [{
    ...
    value: function setCountryCode() {
      this.countryCode = 'gb';
      this.setCurrencySymbol(); // fetch('http://ip-api.com/json')
    ...
    value: function configureFormListener() {
      ...
      this.searchForm.addEventListener('submit', function (event) {
        ...
        fetch("http://localhost:3000/?search=".concat(search, "&location=").concat(location, "&country=").concat(_this.countryCode)).then(function (response) {
          ...
          return results.map(function (job) {
            return (0, _templates.jobTemplate)(job, _this.currencySymbol);
          }).join('');
        }).then(function (jobs) {
          return _this.resultsContainer.innerHTML = jobs;
        }).catch(function () {
